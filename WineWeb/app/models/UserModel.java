...
public class UserModel extends Model implements Serializable, IConst {
	...
	public String invoiceTitle = "个人";// 发票抬头
	...
	// 生成分销二维码
//	public static String generateResellerCodeBarcode(String code) throws Exception {
...
//
//		play.Logger.error(DateUtil.Date2Str(new Date()) + " - create reseller barcode: " + code + ".gif");
//		return code + ".gif";
//	}
