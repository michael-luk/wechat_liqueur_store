...
var uploadSmallImage = '<div> <input type="file" name="files[]" accept="image/*" ng-file-select="uploadImage($files, col.field, row.entity)"/>   <a class="fancybox" data-fancybox-group="gallery" fancybox ng-if="isShowImg(COL_FIELD)" ng-href="/showImage/{{COL_FIELD}}"><img ng-src="/showimg/thumb/{{COL_FIELD}}" style="width:100px;height:100px" ></a></div>';
...
app.controller('InfoBackendController', ['$scope', '$http', '$upload', 'createDialog', '$log', function ($scope, $http, $upload, createDialogService, $log) {
    ...
    $scope.gridOptions = { data: 'list',
        ...
        columnDefs: [
            ...
            {field: 'phone', displayName: '联系电话', width: '120', enableCellEdit: true, editableCellTemplate: cellEditableTemplate},
            {field: 'url', displayName: 'url', width: '120', enableCellEdit: true, editableCellTemplate: cellEditableTemplate},
            {field: 'imageList', displayName: '图片', cellTemplate: uploadTemplateInfo, width: '**'},
            {field: 'smallImages', displayName: '小图片', cellTemplate: uploadSmallImage, width: '**'},
            {field: 'description1', displayName: '描述1', width: '150', enableCellEdit: true, editableCellTemplate: cellEditableTemplate},
            {field: 'description2', displayName: '描述2', width: '150', enableCellEdit: true, editableCellTemplate: cellEditableTemplate},
        ] };
