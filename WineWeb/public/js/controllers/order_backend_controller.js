...
app.controller('OrderBackendController', ['$scope', '$http', '$upload', 'createDialog', '$log', function ($scope, $http, $upload, createDialogService, $log) {
 ...
 // 搜索
    $scope.findContent = function(){
    	var url = '/orders?size=6&page=' + $scope.page
    	if($scope.findOrder != null) url += '&keyword=' + $scope.findOrder
    ...
    $scope.gridOptions = { data: 'list',
        ...
        columnDefs: [
            ...
            {field: 'createdAtStr', displayName: '下单时间', width: '110', cellTemplate: '<div ng-bind-html="COL_FIELD | safehtml"></div>'},
            {field: 'buyer', displayName: '购买用户', width: '120', cellTemplate: '<div>{{COL_FIELD.nickname}}</div>'},
            {field: 'refResellerId', displayName: '分销', width: '40'},
            ...
            {field: 'quantity', displayName: '数量', width: '60'},
            {field: 'productAmount', displayName: '商品总额', width: '70'},
            {field: 'shipFee', displayName: '运费', width: '60'},
            {field: 'price', displayName: '订单总额', width: '70'},
            ...
            {field: 'wishImage', displayName: '祝福图片', width: '100', cellTemplate: '<div ng-if="COL_FIELD"> <a class="fancybox" ng-href="/showImage/{{COL_FIELD}}"><img ng-src="/showimg/thumb/{{COL_FIELD}}" style="width:100px;height:100px" ></a></div>'},
            ...
            {field: 'logisticsCompany', displayName: '物流公司', width: '120', enableCellEdit: true, editableCellTemplate: cellEditableTemplateOrders, cellTemplate: '<div ng-bind-html="COL_FIELD | safehtml"></div>'},
            {field: 'numberOfLogistics', displayName: '物流单号', width: '120', enableCellEdit: true, editableCellTemplate: cellEditableTemplateOrders, cellTemplate: '<div ng-bind-html="COL_FIELD | safehtml"></div>'},
            {field: 'shipTimeStr', displayName: '发货时间', width: '120', enableCellEdit: true, editableCellTemplate: cellEditableTemplateOrders, cellTemplate: '<div ng-bind-html="COL_FIELD | safehtml"></div>'},
