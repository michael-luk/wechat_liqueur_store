...
//    }, false);
    ...
    $scope.gridOptions = { data: 'list',
        ...
        columnDefs: [
            ...
            {field: 'productName', displayName: '所属产品', width: '230', enableCellEdit: false, cellTemplate: '<div ng-bind-html="COL_FIELD | safehtml"></div>'},
            {field: 'refProductId', displayName: '所属产品Id', width: '85', enableCellEdit: false},
            {field: 'name', displayName: '名称', width: '100', enableCellEdit: true, editableCellTemplate: cellEditableTemplate},
            {field: 'imageList', displayName: '图片', cellTemplate: uploadTemplateTheme, width: '**'},
            {field: 'comment', displayName: '备注', width: '300', enableCellEdit: true, editableCellTemplate: cellEditableTemplate},
        ] };
    ...
    function fillGridWithProducts(){
    	if($scope.page2){
    		$http.get('/products?size=200&page=' + $scope.page2).success(function (data, status, headers, config) {
    		/*	$log.log(data)*/
    			if (data.flag) {
    ...
    $scope.gridProducts = { data: 'list2',
        ...
        columnDefs: [
            {field: 'id', displayName: 'Id', width: '40'},
            {field: 'name', displayName: '所属产品', width: '315'},
        ] };
}]);
